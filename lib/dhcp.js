...
exports.DHCPOptionsFnc = model_2.DHCPOptionsFnc;
exports.createBroadcastHandler = () => new Server_1.Server(new ServerConfig_1.ServerConfig({ range: ["0.0.0.0", "0.0.0.1"] }), true);
