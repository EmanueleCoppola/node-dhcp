...
const StaticLeaseStoreMemory_1 = require("./staticLeaseStore/StaticLeaseStoreMemory");
const LeaseStoreMemory_1 = require("./leaseStore/LeaseStoreMemory");
...
class ServerConfig extends DHCPOptions_1.DHCPOptions {
    constructor(options) {
        ...
        this.static = options.static || new StaticLeaseStoreMemory_1.StaticLeaseStoreMemory({});
        this.range = options.range;
        this.leaseState = options.leaseState || new LeaseStoreMemory_1.LeaseStoreMemory();
