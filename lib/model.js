...
(function (OptionId) {
    ...
    OptionId[OptionId["tcpKeepalive"] = 38] = "tcpKeepalive";
    OptionId[OptionId["tcpKeepaliveGarbage"] = 39] = "tcpKeepaliveGarbage";
    ...
    OptionId[OptionId["netwareIPDomainName"] = 62] = "netwareIPDomainName";
    OptionId[OptionId["netwareIPDomainInfp"] = 63] = "netwareIPDomainInfp";
    OptionId[OptionId["NIS+Domain"] = 64] = "NIS+Domain";
    OptionId[OptionId["NIS+Server"] = 65] = "NIS+Server";
    OptionId[OptionId["tftpServer"] = 66] = "tftpServer";
    OptionId[OptionId["bootfileName"] = 67] = "bootfileName";
    OptionId[OptionId["mobileIPHomeAgent"] = 68] = "mobileIPHomeAgent";
    ...
    OptionId[OptionId["userClass"] = 77] = "userClass";
    OptionId[OptionId["SLPDirectoryAgent"] = 78] = "SLPDirectoryAgent";
    OptionId[OptionId["SLPServiceScope"] = 79] = "SLPServiceScope";
    OptionId[OptionId["rapidCommit"] = 80] = "rapidCommit";
    OptionId[OptionId["PCode"] = 100] = "PCode";
    OptionId[OptionId["TCode"] = 101] = "TCode";
    OptionId[OptionId["netinfoServerAddress"] = 112] = "netinfoServerAddress";
    OptionId[OptionId["netinfoServerTag"] = 113] = "netinfoServerTag";
    OptionId[OptionId["autoConfigure"] = 116] = "autoConfigure";
    OptionId[OptionId["subnetSelection"] = 118] = "subnetSelection";
    OptionId[OptionId["domainSearchList"] = 119] = "domainSearchList";
    OptionId[OptionId["SIPServerDHCPOption"] = 120] = "SIPServerDHCPOption";
    OptionId[OptionId["classlessRoute"] = 121] = "classlessRoute";
    OptionId[OptionId["vivso"] = 125] = "vivso";
